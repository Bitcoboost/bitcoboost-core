...
struct Params {
    ...
    /** Bitcoboost: retarget veloce iniziale per stabilizzare la difficolta nei primi blocchi.
     * Per i primi nFastRetargetUntilHeight blocchi, retargeta ogni nFastRetargetPeriod blocchi
